...
export default function Lab1() {
    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>
            In a bowl, whisk together 1 cup flour, 2 tbsp sugar, 2 tsp baking
            powder, and a pinch of salt.
          </li>
          <li>
            In another bowl, mix 1 cup milk, 1 egg, and 2 tbsp melted butter (or
            oil).
          </li>
          <li>Pour the wet mixture into the dry ingredients.</li>
          <li>Stir gently until just combined (do not overmix).</li>
          <li>Heat a lightly oiled skillet or griddle over medium heat.</li>
          <li>Pour about 1/4 cup batter for each pancake onto the skillet.</li>
          <li>Cook until bubbles form on top and the edges look set.</li>
          <li>Flip and cook until golden brown on the other side.</li>
          <li>Serve warm with syrup, butter, or toppings of your choice!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Lord of the Rings</li>
          <li>Narnia: The Lion, the witch and the wardrobe.</li>
          <li>Harry Potter</li>
  ...
  <img id="wd-starship" width="400px" alt=""  src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" />
  <br />
  Loading a local image:
  <br />
  <img id="wd-teslabot" alt="" src="/images/teslabot.jpg" height="200px" /></div>
  <div id="wd-forms">
  <h4>Form Elements</h4>
